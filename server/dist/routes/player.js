...
router.get("/goal-rank", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var playerData;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, player_data_1.PlayerData.find({
...
router.get("/assist-rank", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var playerData;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, player_data_1.PlayerData.find({
...
router.post("/", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var data, playerData, newData;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                data = req.body;
                return [4 /*yield*/, player_data_1.PlayerData.findOne({ name: data.name })];
            case 1:
                playerData = _a.sent();
                if (playerData) {
                    return [2 /*return*/, res
                ...
                newData = new player_data_1.PlayerData(data);
...
router.put("/:id", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, command, playerData;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                command = req.body;
                return [4 /*yield*/, player_data_1.PlayerData.findOne({ name: command.name })];
            case 1:
                playerData = _a.sent();
                ...
                return [4 /*yield*/, player_data_1.PlayerData.findByIdAndUpdate(id, command)];
            case 2:
                _a.sent();
                res.end();
                return [2 /*return*/];
...
router.delete("/:id", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, player_data_1.PlayerData.findByIdAndRemove(id)];
            case 1:
                _a.sent();
                res.end();
                return [2 /*return*/];
